...
public class RegistrationEmailSender implements EventListener {
	...
	private void sendEmail(String from, Student student, String email) throws SparkPostException {
	    ...
	    contentAttributes.setText("Dear {{name}}, thank you for your subscription. "
	    		+"Please visit the following link to activate your subsciption {{host}}/activate?activationCode={{activationCode}}");
	    transmission.setContentAttributes(contentAttributes);
